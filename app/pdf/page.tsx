    ...
    try {
      ...
      const pdf = new jsPDF({
        ...
        encryption: {
          ...
          userPermissions: ["print"], // set allowed permissions
        },
      });
            ...
            <div className="relative z-10 flex flex-col h-full text-black">
                    ...
                    <ol className="text-[15.5px] leading-normal text-black space-y-2">
                      <li className="flex gap-4">
                        ...
                        <span>
                          ...
                          must be presented to the immigration officer upon
                          arrival at the designated point of entry.
                        </span>
                      </li>
                      <li className="flex gap-4">
                        <span className="min-w-3.75">2.</span>
                        <span>
                          This Travel Authorization allows for a single entry
                          and is valid for 90 days from the date of approval.
                        </span>
                      </li>
                      <li className="flex gap-4">
                        ...
                        <span>
                          ...
                          constitutes a criminal offense and is punishable by
                          law.
                        </span>
                      </li>
                    </ol>
              ...
              <div className="text-center mt-6 font-semibold text-gray-800 text-[13px]">
                <p className="uppercase leading-tight tracking-wider font-serif-official">
                  THIS DOCUMENT WAS ISSUED UNDER THE AUTHORITY OF IMMIGRATION
